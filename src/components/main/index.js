...
function Main() {
  return (
    <div>
      <main class='flex-grow pt-8 mx-4 md:mx-16'>
        <div class='flex items-center'>
          <div class='text-lg md:text-2xl md:pr-12 lg:pr-0 xl:pr-8'>
            <div>
              <svg
                version='1.1'
		...
		C644,312.2,621.1,332.1,585.7,347.1z'
            ...
            <div class='pt-8 text-center'>
              <a
                href='https://github.com/ayradc/react-parcel'
                target='_blank'
                class='text-blue-600 '>
                Minimal react parcel boilerplate for Development/Production
                powered projects
              </a>
            </div>
          </div>
